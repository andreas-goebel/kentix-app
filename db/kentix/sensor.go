...
var SensorWhere = struct {
	...
	ProjectID:    whereHelperint32{field: "\"kentix\".\"sensor\".\"project_id\""},
	AssetID:      whereHelpernull_Int32{field: "\"kentix\".\"sensor\".\"asset_id\""},
	SerialNumber: whereHelperint32{field: "\"kentix\".\"sensor\".\"serial_number\""},
}
...
var (
	sensorAllColumns            = []string{"id", "project_id", "asset_id", "serial_number"}
	sensorColumnsWithoutDefault = []string{"project_id", "serial_number"}
	sensorColumnsWithDefault    = []string{"id", "asset_id"}
...
func (q sensorQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Sensor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbkentix: failed to execute a one query for sensor")
	}
...
func (q sensorQuery) All(ctx context.Context, exec boil.ContextExecutor) (SensorSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbkentix: failed to assign all query results to Sensor slice")
	}
...
func (q sensorQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: failed to count sensor rows")
	}
...
func (q sensorQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbkentix: failed to check if sensor exists")
	}
...
func Sensors(mods ...qm.QueryMod) sensorQuery {
	mods = append(mods, qm.From("\"kentix\".\"sensor\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"kentix\".\"sensor\".*"})
	}
...
func FindSensor(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Sensor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbkentix: unable to select from sensor")
	}
...
func (o *Sensor) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbkentix: no sensor provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"kentix\".\"sensor\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"kentix\".\"sensor\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "dbkentix: unable to insert into sensor")
	}
...
func (o *Sensor) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbkentix: unable to update sensor, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"kentix\".\"sensor\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to update sensor row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: failed to get rows affected by update for sensor")
	}
...
func (q sensorQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to update all for sensor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to retrieve rows affected for sensor")
	}
...
func (o SensorSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"kentix\".\"sensor\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to update all in sensor slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to retrieve rows affected all in update all sensor")
	}
	return rowsAff, nil
}

// UpsertG attempts an insert, and does an update or ignore on conflict.
func (o *Sensor) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
...
func (o *Sensor) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("dbkentix: no sensor provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbkentix: unable to upsert sensor, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"kentix\".\"sensor\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "dbkentix: unable to upsert sensor")
	}
...
func (o *Sensor) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbkentix: no Sensor provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to delete from sensor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: failed to get rows affected by delete for sensor")
	}
...
func (q sensorQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbkentix: no sensorQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to delete all from sensor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: failed to get rows affected by deleteall for sensor")
	}
...
func (o SensorSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"kentix\".\"sensor\" WHERE " +
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to delete all from sensor slice")
	}
...
func (o *Sensor) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbkentix: no Sensor provided for reload")
	}
...
func (o *SensorSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbkentix: empty SensorSlice provided for reload all")
	}
...
func (o *SensorSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"kentix\".\"sensor\".* FROM \"kentix\".\"sensor\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, sensorPrimaryKeyColumns, len(*o))
	...
	if err != nil {
		return errors.Wrap(err, "dbkentix: unable to reload all in SensorSlice")
	}
...
func SensorExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbkentix: unable to check if sensor exists")
	}
