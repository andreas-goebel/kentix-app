...
var ConfigurationWhere = struct {
	...
	ID:              whereHelperint64{field: "\"kentix\".\"configuration\".\"id\""},
	Address:         whereHelpernull_String{field: "\"kentix\".\"configuration\".\"address\""},
	APIKey:          whereHelpernull_String{field: "\"kentix\".\"configuration\".\"api_key\""},
	Enable:          whereHelpernull_Bool{field: "\"kentix\".\"configuration\".\"enable\""},
	RefreshInterval: whereHelperint32{field: "\"kentix\".\"configuration\".\"refresh_interval\""},
	RequestTimeout:  whereHelperint32{field: "\"kentix\".\"configuration\".\"request_timeout\""},
	Active:          whereHelpernull_Bool{field: "\"kentix\".\"configuration\".\"active\""},
	ProjectIds:      whereHelpertypes_StringArray{field: "\"kentix\".\"configuration\".\"project_ids\""},
}
...
func (q configurationQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Configuration, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbkentix: failed to execute a one query for configuration")
	}
...
func (q configurationQuery) All(ctx context.Context, exec boil.ContextExecutor) (ConfigurationSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbkentix: failed to assign all query results to Configuration slice")
	}
...
func (q configurationQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: failed to count configuration rows")
	}
...
func (q configurationQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbkentix: failed to check if configuration exists")
	}
...
func (o *Configuration) Sensors(mods ...qm.QueryMod) sensorQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"kentix\".\"sensor\".\"configuration_id\"=?", o.ID),
	)
...
func (configurationL) LoadSensors(ctx context.Context, e boil.ContextExecutor, singular bool, maybeConfiguration interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`kentix.sensor`),
		qm.WhereIn(`kentix.sensor.configuration_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	for _, rel := range related {
		if insert {
			...
			updateQuery := fmt.Sprintf(
				"UPDATE \"kentix\".\"sensor\" SET %s WHERE %s",
...
func Configurations(mods ...qm.QueryMod) configurationQuery {
	mods = append(mods, qm.From("\"kentix\".\"configuration\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"kentix\".\"configuration\".*"})
	}
...
func FindConfiguration(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Configuration, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"kentix\".\"configuration\" where \"id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbkentix: unable to select from configuration")
	}
...
func (o *Configuration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbkentix: no configuration provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"kentix\".\"configuration\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"kentix\".\"configuration\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "dbkentix: unable to insert into configuration")
	}
...
func (o *Configuration) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbkentix: unable to update configuration, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"kentix\".\"configuration\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to update configuration row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: failed to get rows affected by update for configuration")
	}
...
func (q configurationQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to update all for configuration")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to retrieve rows affected for configuration")
	}
...
func (o ConfigurationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if len(cols) == 0 {
		return 0, errors.New("dbkentix: update all requires at least one column argument")
	}
	...
	sql := fmt.Sprintf("UPDATE \"kentix\".\"configuration\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to update all in configuration slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to retrieve rows affected all in update all configuration")
	}
	return rowsAff, nil
}
...
func (o *Configuration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("dbkentix: no configuration provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbkentix: unable to upsert configuration, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"kentix\".\"configuration\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "dbkentix: unable to upsert configuration")
	}
...
func (o *Configuration) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbkentix: no Configuration provided for delete")
	}
	...
	sql := "DELETE FROM \"kentix\".\"configuration\" WHERE \"id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to delete from configuration")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: failed to get rows affected by delete for configuration")
	}
...
func (q configurationQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbkentix: no configurationQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to delete all from configuration")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: failed to get rows affected by deleteall for configuration")
	}
...
func (o ConfigurationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"kentix\".\"configuration\" WHERE " +
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbkentix: unable to delete all from configuration slice")
	}
...
func (o *Configuration) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbkentix: no Configuration provided for reload")
	}
...
func (o *ConfigurationSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbkentix: empty ConfigurationSlice provided for reload all")
	}
...
func (o *ConfigurationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"kentix\".\"configuration\".* FROM \"kentix\".\"configuration\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, configurationPrimaryKeyColumns, len(*o))
	...
	if err != nil {
		return errors.Wrap(err, "dbkentix: unable to reload all in ConfigurationSlice")
	}
...
func ConfigurationExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"kentix\".\"configuration\" where \"id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbkentix: unable to check if configuration exists")
	}
